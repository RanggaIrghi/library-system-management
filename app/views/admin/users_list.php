<div class="flex justify-between items-center px-5 py-6">
                ...
                <div class="flex space-x-4">
                    ...
                    <form action="<?= BASE_URL; ?>/admin/searchUser" class="flex" method="post">
                    ...
                    <table class="w-full text-base text-left rtl:text-right">
                        ...
                        <?php foreach($data['user'] as $usr): ?>
                            <tr class="text-center">
                                ...
                                <td class="px-6 py-3"><?= $usr['fullname'] ?></td>
                                <td class="px-6 py-3"><?= $usr['tgl_lahir'] ?></td>
                                <td class="px-6 py-3"><?= $usr['no_hp'] ?></td>
                                <td class="flex justify-center space-x-2 px-6 py-3">
                                    <button class="changeModal" onclick="showModal('popupModal')" data-id="<?= $usr['id_user']; ?>" data-type="getUser">
                                        <i data-feather="edit" class="w-6 h-6"></i>
                                    </button>
                                    <button class="DeleteModal" id="deleteModalbtn" data-id="<?= $usr['id_user']; ?>" onclick="showModal('deleteModal')" data-type="delete_user">
                                        <i data-feather="trash" class="w-6 h-6"></i>
                                    </button>
                                    <button class="detailModal" onclick="showModal('detailModal')" data-id="<?= $usr['id_user']; ?>" data-type="getUser">
                    ...
                    <div class="relative p-4 w-full max-w-xl max-h-full">
                        <div class="relative bg-white rounded-lg shadow px-4 modal-body">
                            ...
                            <form action="<?= BASE_URL; ?>/admin/add_user" method="post">
                                ...
                                <input type="text" class="w-full h-12 my-4 px-4 rounded-lg ring-2 ring-black focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-sky-500" id="nik" name="nik" placeholder="NIK">
