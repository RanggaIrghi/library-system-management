            <div class="flex justify-between items-center px-5 py-6">
                <h1 class="text-2xl font-bold">Borrowed Books Management</h1>
            ...
            <div class="w-full px-4 block" id="borrBooks">
                <div class="rounded-lg bg-white shadow-lg">
                    <table class="w-full text-base text-left rtl:text-right">
                        ...
                        <?php foreach($data['peminjaman'] as $brrw): ?>
                            <tr class="text-center">
                                <td class="px-6 py-3"><?= $brrw['id_pinjam'] ?></td>
                                <td class="px-6 py-3"><?= $brrw['fullname'] ?></td>
                                <td class="px-6 py-3"><?= $brrw['judul'] ?></td>
                                <td class="px-6 py-3"><?= $brrw['tnggl_pinjam'] ?></td>
                                <td class="px-6 py-3"><?= $brrw['bts_pinjam'] ?></td>
                                <td class="flex justify-center space-x-2 px-6 py-3">
                                    <button class="checkModal" id="checkBtn" data-id="<?= $brrw['id_pinjam']; ?>" onclick="showModal('checkModal')" data-type="check_borrowed">
                                        <i data-feather="check-circle" class="w-6 h-6"></i>
                                    <button class="DeleteModal" id="deleteModalbtn" data-id="<?= $brrw['id_pinjam']; ?>" onclick="showModal('deleteModal')" data-type="delete_borrowed">
                                        <i data-feather="trash" class="w-6 h-6"></i>
                                    </button>
                                    <button class="detailModal" onclick="showModal('detailModal')" data-id="<?= $brrw['id_pinjam']; ?>" data-type="getBorrow">
            ...
            <div class="w-full px-4 hidden" id="dueBooks">
                <div class="rounded-lg bg-white shadow-lg">
                    <table class="w-full text-base text-left rtl:text-right">
                        <tr class="text-center">
                            <th class="px-6 py-3 border-b-2 border-black">ID</th>
                        ...
                        <?php foreach($data['dueDate'] as $brrw): ?>
                            <tr class="text-center">
                                <td class="px-6 py-3"><?= $brrw['id_pinjam'] ?></td>
                                <td class="px-6 py-3"><?= $brrw['fullname'] ?></td>
                                <td class="px-6 py-3"><?= $brrw['judul'] ?></td>
            ...
            <div class="hidden justify-center items-center" id="checkModal">
                <div class="w-full h-screen flex overflow-y-auto overflow-x-hidden bg-black-rgba fixed  top-0 right-0 left-0 z-50 justify-center items-center">
                    <div class="relative p-4 w-full max-w-xl max-h-full">
                        <div class="relative bg-white rounded-lg shadow px-4 pb-8 modal-body">
                            <div class="flex items-center justify-start p-8 border-b-2 border-black">
                                ...
                                <h2 class="text-2xl ms-3" id="formLabel">Return Confirmation</h2>
                            </div>
                            <div class="w-full mx-auto my-4 text-lg">
                                <p id="message">"Are you certain you wish to proceed the return of the selected entry?"</p>
                            </div>
                            <button type="button" class="absolute top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h8 ms-auto inline-flex justify-center items-center" data-modal-hide=
                                "popupModal" id="btnClose" onclick="closeModal('checkModal')">
                                    <i data-feather="x"></i>
                                </button>
                            <button class="py-4 px-8 mt-8 text-white bg-black hover:bg-gray-100 hover:text-red-600 rounded-lg" id="returnBtn">CONFIRM</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="w-full h-screen flex overflow-y-auto overflow-x-hidden bg-black-rgba fixed  top-0 right-0 left-0 z-50 justify-center items-center">
                    <div class="relative p-4 w-full max-w-xl max-h-full">
                        <div class="relative bg-white rounded-lg shadow px-4 pb-8 modal-body">
                            ...
                            <div class="w-full mx-auto my-4 text-lg">
                                <p id="message">"Are you certain you wish to proceed with the deletion of the selected entry?"</p>
                            </div>
                            <button type="button" class="absolute top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h8 ms-auto inline-flex justify-center items-center" data-modal-hide=
